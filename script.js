document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function clearFieldStyle(field) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (!successEl) {
        ...
        successEl.style.cssText = 'padding:12px;background:#c6f6d5;color:#276749;border-radius:4px;margin-top:12px;';
  ...
  // ============================================================
  const ANIMATION_CLASS = 'fade-in-element';
  ...
  animationStyles.textContent = [
    ...
    '.' + ANIMATION_CLASS + '.is-visible{opacity:1;transform:translateY(0);}'
  ].join('');
  document.head.appendChild(animationStyles);

  const scrollElements = document.querySelectorAll(
    '.animate, [data-animate], .fade-in, .scroll-animate, section > .container, .card, .feature, .testimonial, .pricing-card, .hero-content'
  );
  ...
  function handleScrollAnimations() {
    const targets = document.querySelectorAll('.' + ANIMATION_CLASS + ':not(.' + VISIBLE_CLASS + ')');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '792fd9ea-2c52-40f7-bb24-b44837b1c9a3',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '792fd9ea-2c52-40f7-bb24-b44837b1c9a3';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '792fd9ea-2c52-40f7-bb24-b44837b1c9a3';
